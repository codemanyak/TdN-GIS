...
vlayer = QgsProject.instance().mapLayersByName("richtungs_folge")[0]
# Wegeliste erstellen"
wegeliste = []
...
def checkbox_dialog(items,title="Etappenabschnitte  wählen"):
    """
...
wegenamen = checkbox_dialog(wegeliste,"Etappen-Abschnitte wählen")
print(wegenamen)
